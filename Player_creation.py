...
df_players = pd.read_csv('Data/atp_players.csv', header=None, names=[1, 2, 3, 4, 5, 6, 7, 8], encoding="ISO-8859-1")
...
with open('Player_Year_Profiles/Players_%i_profiles' % year_to_study, 'wb') as file:
