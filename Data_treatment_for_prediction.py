...
parser.add_argument('--year_study', help='yeau to study (int)', default=2015) #choisir le nom du ficher
parser.add_argument('--year_model', help='yeau to study (int)', default=2012) #choisir le nom du ficher
args = parser.parse_args()

year_to_treat = int(args.year_study)
model_year = int(args.year_model)



with open('Data_year/Data_%i' % year_to_treat, 'rb') as file:
